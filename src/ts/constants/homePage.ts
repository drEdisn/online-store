export const homePage = `
  <section class="home__top">
    <div class="top-text">
      <h1 class="title top-title">Design Your Comfort Zone</h1>
      <p class="story__text top-lorem">
      ...
      <button class="home-button home__top-button">SHOP NOW</button>
    </div>
    <div class="top-image">
      <img class="top-image__1" src="./images/about-img.jpeg" alt="home">
      <img class="top-image__2" src="./images/home-top.jpeg" alt="home">
    </div>
  </section>
